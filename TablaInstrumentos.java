...
public class TablaInstrumentos extends JPanel {
   ...
   TablaInstrumentos.ChannelData[] channels;
   TablaInstrumentos.ChannelData cc;
   JTable table;
   JSlider veloS;
   JSlider presS;
   JSlider bendS;
   ...
   public void open() {
      ...
      this.channels = new TablaInstrumentos.ChannelData[midiChannels.length];

      for(int i = 0; i < this.channels.length; ++i) {
         this.channels[i] = new TablaInstrumentos.ChannelData(midiChannels[i], i);
      }
   ...
   public TablaInstrumentos(ClienteUDP cli, WireOutput output) {
      ...
      TableModel dataModel = new AbstractTableModel() {
         public int getColumnCount() {
            return TablaInstrumentos.this.nCols;
         }

         public int getRowCount() {
            return TablaInstrumentos.this.nRows;
         }

         public Object getValueAt(int r, int c) {
            return TablaInstrumentos.this.instruments != null ? TablaInstrumentos.this.instruments[c * TablaInstrumentos.this.nRows + r].getName() : Integer.toString(c * TablaInstrumentos.this.nRows + r);
         }

         public String getColumnName(int c) {
            return TablaInstrumentos.this.names[c];
         }
      ...
      lsm.addListSelectionListener(new ListSelectionListener() {
         public void valueChanged(ListSelectionEvent e) {
            ...
            if (!sm.isSelectionEmpty()) {
               TablaInstrumentos.this.cc.row = sm.getMinSelectionIndex();
               System.out.println("la seleccion es" + sm.getMinSelectionIndex());
            }

            TablaInstrumentos.this.enviarEventoInstrumento(192, TablaInstrumentos.this.cc.col * TablaInstrumentos.this.nRows + TablaInstrumentos.this.cc.row);
         }
      });
      lsm = this.table.getColumnModel().getSelectionModel();
      lsm.addListSelectionListener(new ListSelectionListener() {
         public void valueChanged(ListSelectionEvent e) {
            ListSelectionModel sm = (ListSelectionModel)e.getSource();
            if (!sm.isSelectionEmpty()) {
               TablaInstrumentos.this.cc.col = sm.getMinSelectionIndex();
               System.out.println("la seleccion es" + sm.getMinSelectionIndex());
            }
   ...
   public void enviarEventoInstrumento(int type, int num) {
      ...
      try {
         ...
         this.cli.enviar(type, num, this.cc.velocity, "SIMULAR");
   ...
   class ChannelData {
      ...
      public void setComponentStates() {
         TablaInstrumentos.this.table.setRowSelectionInterval(this.row, this.row);
         TablaInstrumentos.this.table.setColumnSelectionInterval(this.col, this.col);
         JSlider[] slider = new JSlider[]{TablaInstrumentos.this.veloS, TablaInstrumentos.this.presS, TablaInstrumentos.this.bendS, TablaInstrumentos.this.revbS};
